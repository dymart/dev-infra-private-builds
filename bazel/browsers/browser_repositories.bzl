...
load("@dev-infra@npm//@angular/dev-infra-private/bazel/browsers/chromium:chromium.bzl", "define_chromium_repositories")
load("@dev-infra@npm//@angular/dev-infra-private/bazel/browsers/firefox:firefox.bzl", "define_firefox_repositories")
